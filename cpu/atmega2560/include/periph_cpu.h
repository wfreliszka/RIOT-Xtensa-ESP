 ...
 */
#define CPU_ATMEGA_EXT_INTS    { GPIO_CPU_PIN(PORT_D, 0), \
                                 GPIO_CPU_PIN(PORT_D, 1), \
                                 GPIO_CPU_PIN(PORT_D, 2), \
                                 GPIO_CPU_PIN(PORT_D, 3), \
                                 GPIO_CPU_PIN(PORT_E, 4), \
                                 GPIO_CPU_PIN(PORT_E, 5), \
                                 GPIO_CPU_PIN(PORT_E, 6), \
                                 GPIO_CPU_PIN(PORT_E, 7) }
