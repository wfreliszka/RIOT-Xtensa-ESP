...
int gpio_ext_init_notsup(void *dev, gpio_pin_t pin, gpio_mode_t mode)
{
    (void)dev;
    (void)pin;
    (void)mode;
...
int gpio_ext_init_int_notsup(void *dev, gpio_pin_t pin, gpio_mode_t mode,
...
void gpio_ext_irq_enable_notsup(void *dev, gpio_pin_t pin)
{
    (void)dev;
    (void)pin;
...
void gpio_ext_irq_disable_notsup(void *dev, gpio_pin_t pin)
{
    (void)dev;
    (void)pin;
...
int gpio_ext_read_notsup(void *dev, gpio_pin_t pin)
{
    (void)dev;
    (void)pin;
...
void gpio_ext_set_notsup(void *dev, gpio_pin_t pin)
{
    (void)dev;
    (void)pin;
...
void gpio_ext_clear_notsup(void *dev, gpio_pin_t pin)
{
    (void)dev;
    (void)pin;
...
void gpio_ext_toggle_notsup(void *dev, gpio_pin_t pin)
{
    (void)dev;
    (void)pin;
...
void gpio_ext_write_notsup(void *dev, gpio_pin_t pin, int value)
{
    (void)dev;
    (void)pin;
    (void)value;
...
const gpio_driver_t gpio_ext_notsup_driver = {
