...
#ifndef GPIO_CPU_PIN
#define GPIO_CPU_PIN(x,y)   ((gpio_pin_t)((x & 0) | y))
#endif
...
/**
 * @brief   Convert (dev, num) tuple for extension devices to gpio_t structure.
 */
#ifndef GPIO_EXT_PIN
#define GPIO_EXT_PIN(x, y)  ((gpio_t){ .dev = x, .num = y })
#endif
 ...
 */
#ifndef GPIO_PIN
#define GPIO_PIN(x, y)      GPIO_EXT_PIN(&gpio_cpu_dev, GPIO_CPU_PIN(x, y))
#endif
...
/** TODO Document */
extern const gpio_dev_t gpio_cpu_dev;
