...
int test_gpio_init(void *dev, gpio_pin_t pin, gpio_mode_t mode);
int test_gpio_init_int(void *dev, gpio_pin_t pin, gpio_mode_t mode,
                       gpio_flank_t flank, gpio_cb_t cb, void *arg);
void test_gpio_irq_enable(void *dev, gpio_pin_t pin);
void test_gpio_irq_disable(void *dev, gpio_pin_t pin);
int test_gpio_read(void *dev, gpio_pin_t pin);
void test_gpio_set(void *dev, gpio_pin_t pin);
void test_gpio_clear(void *dev, gpio_pin_t pin);
void test_gpio_toggle(void *dev, gpio_pin_t pin);
void test_gpio_write(void *dev, gpio_pin_t pin, int value);

/* GPIO extension test driver */
const gpio_driver_t tests_extend_gpio_driver = {
    .init = test_gpio_init,
